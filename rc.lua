...
globalkeys = gears.table.join(
    awful.key({ modkey, }, "c", function()
        awful.spawn.with_shell("scrot -s |sleep 7; nautilus /home/zer0", false)
    end),
    -- Volume Keys
    awful.key({ modkey, }, "a", function()
        awful.spawn.with_shell("anki", false)
    end),
    awful.key({ modkey, }, "o", function()
        awful.spawn.with_shell("/usr/bin/obsidian", false)
    end),
    awful.key({ modkey, }, "i", function()
        awful.spawn.with_shell("google-chrome", false)
    end),
    ...
    awful.key({ modkey, "Shift" }, "s", function() awful.spawn.with_shell("scrot -s ~/Desktop/screenshot.png") end,
        { description = "Take a screenshot of a selected area", group = "screenshot" }),
    ...
    awful.key({}, "XF86MonBrightnessUp", function()
        awful.util.spawn("xrandr --output eDP-1 --brightness 1.0")
    end),
